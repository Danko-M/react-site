...
export const SectionB = () => 
    ...
    <Row className="section-b">
      <Col sm={4} xs={12}>
      	<h3 className="dashed-underline-left">Pixel Perfect</h3>
      	<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit.</p>
      </Col>
      <Col xs={12} sm={4}>
      	<h3 className="dashed-underline-left">Fully Responsive</h3>
      	<p> Quisquam nobis, eligendi. Earum dolore culpa tenetur qui at, voluptas repellendus quisquam minima incidunt.</p>
      </Col>
      <Col xs={12} sm={4}>
      	<h3 className="dashed-underline-left">Multipurpose Design</h3>
